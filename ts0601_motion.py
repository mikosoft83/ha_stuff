...
class TuyaPirIlluminanceMeasurement(IlluminanceMeasurement, TuyaLocalCluster):
    """Tuya local IlluminanceMeasurement cluster."""
...
class TuyaPirMmwRadarMotionStateEnum(t.enum8):
    """MotionState enum."""
...
class TuyaPirMmwRadarMotionState(TuyaAttributesCluster, MultistateInput):
    """Multistate cluster for motion state"""

    _CONSTANT_ATTRIBUTES = {
        MultistateInput.AttributeDefs.description.id: "motion_state",
        MultistateInput.AttributeDefs.number_of_states.id: 4,
        MultistateInput.AttributeDefs.state_text.id: ['None','Large','Small','Static'],
    }


class TuyaPirMmwRadarFadingTime(TuyaAttributesCluster, AnalogOutput):
    """AnalogOutput cluster for fading time."""

    _CONSTANT_ATTRIBUTES = {
        AnalogOutput.AttributeDefs.description.id: "fading_time",
        AnalogOutput.AttributeDefs.min_present_value.id: 0,
        AnalogOutput.AttributeDefs.max_present_value.id: 28800,
        AnalogOutput.AttributeDefs.resolution.id: 1,
        AnalogOutput.AttributeDefs.engineering_units.id: 73,  # seconds
    }

class TuyaPirMmwRadarStaticDistance(TuyaAttributesCluster, AnalogOutput):
    """AnalogOutput cluster for min range."""

    _CONSTANT_ATTRIBUTES = {
        AnalogOutput.AttributeDefs.description.id: "static_detection_distance",
        AnalogOutput.AttributeDefs.min_present_value.id: 0,
        AnalogOutput.AttributeDefs.max_present_value.id: 1000,
        AnalogOutput.AttributeDefs.resolution.id: 1,
        AnalogOutput.AttributeDefs.engineering_units.id: 118,  # cm
    }

class TuyaPirMmwRadarStaticSensitivity(TuyaAttributesCluster, AnalogOutput):
    """AnalogOutput cluster for sensitivity."""

    _CONSTANT_ATTRIBUTES = {
        AnalogOutput.AttributeDefs.description.id: "static_detection_sensitivity",
        AnalogOutput.AttributeDefs.min_present_value.id: 1,
        AnalogOutput.AttributeDefs.max_present_value.id: 10,
        AnalogOutput.AttributeDefs.resolution.id: 1,
    }

class TuyaPirMmwRadarIndicator(TuyaAttributesCluster, OnOff):
    """AnalogOutput cluster for sensitivity."""

#    _CONSTANT_ATTRIBUTES = {
#        BinaryOutput.AttributeDefs.description.id: "indicator",
#    }
...
class TuyaPirMmwRadarClusterBase(NoManufacturerCluster, TuyaMCUCluster):
    """Pir+Mmw radar cluster, base class."""
    ...
    attributes.update(
        {
            # ramdom attribute IDs
            0xEF01: ("occupancy", t.uint32_t, True),
            0xEF02: ("motion_state", t.enum8, True),
            0xEF03: ("fading_time", t.uint32_t, True),
            0xEF04: ("static_detection_distance", t.uint32_t, True),
            0xEF09: ("static_detection_sensitivity", t.uint32_t, True),
            0xEF68: ("illuminance", t.uint32_t, True),
            0xEF68: ("indicator", t.uint32_t, True),
            0xEF68: ("battery", t.uint32_t, True),
        }
    )

class TuyaPirMmwRadarClusterV1(TuyaPirMmwRadarClusterBase):
    """Pir+Mmw radar cluster, variant 1."""
    ...
    dp_to_attribute: Dict[int, DPToAttributeMapping] = {
        ...
        2: DPToAttributeMapping(
            TuyaPirMmwRadarStaticSensitivity.ep_attribute,
            "present_value",
            endpoint_id=2
        ),
        4: DPToAttributeMapping(
            TuyaPirMmwRadarStaticDistance.ep_attribute,
            "present_value",
            endpoint_id=3,
        ),
        101: DPToAttributeMapping(
            TuyaPirMmwRadarMotionState.ep_attribute,
            "present_value",
            #converter=lambda x: x+1,
            endpoint_id=6
        ),
        102: DPToAttributeMapping(
            TuyaPirMmwRadarFadingTime.ep_attribute,
            "present_value",
            endpoint_id=4,
        ),
        #106: DPToAttributeMapping(
        #    TuyaPirIlluminanceMeasurement.ep_attribute,
        #    "measured_value",
        #    converter=lambda x: int(math.log10(x) * 10000 + 1) if x > 0 else int(0),
        #),
        107: DPToAttributeMapping(
            TuyaPirMmwRadarIndicator.ep_attribute,
            #"present_value",
            "on_off",
            endpoint_id=5,
        ),
...
class TuyaPirMmwRadarOccupancyVariant1(CustomDevice):
    """Pir+Millimeter wave occupancy sensor."""
        ...
        ENDPOINTS: {
            1: {
                ...
                INPUT_CLUSTERS: [
                    ...
                    Identify.cluster_id,
                    IlluminanceMeasurement.cluster_id, # (1024)
    ...
    replacement = {
        ENDPOINTS: {
            1: {
                ...
                INPUT_CLUSTERS: [
                    Basic.cluster_id,
                    TuyaPirMmwRadarClusterV1,
                    TuyaOccupancySensing,
                    TuyaPirIlluminanceMeasurement,
                    TuyaPowerConfigurationCluster2AAA,
                    TuyaPirMmwRadarMotionState,
                ],
                OUTPUT_CLUSTERS: [],
            },
            2: {
                ...
                INPUT_CLUSTERS: [
                    TuyaPirMmwRadarStaticSensitivity,
